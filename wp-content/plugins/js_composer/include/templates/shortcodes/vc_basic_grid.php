...
?>
<!-- vc_grid start -->
<div class="vc_grid-container wpb_content_element<?php echo esc_attr($css_classes) ?>" data-vc-<?php echo $this->pagable_type ?>-settings="<?php echo esc_attr( json_encode( $this->grid_settings ) ) ?>">
</div><!-- vc_grid end -->
